...
$string['editingpage'] = 'File \'{$a}\'';
$string['errorscompilation'] = 'Compilation Errors';
$string['errorscompilation_help'] = 'Number of erroneous compilations';
$string['files'] = 'Files';
...
To create a new page, type the new page name enclosed in double square brackets, for example [[Page 2]].';
$string['formatcreole_link'] = 'mod/wikicode/creole';
...
To create a new page, type the new page name enclosed in double square brackets, for example [[Page 2]].';
$string['formatnwiki_link'] = 'mod/wikicode/nwiki';
$string['gccpath'] = 'Unix Path';
$string['gccpath_help'] = 'Path to the compiler for Unix executable';
...
$string['log'] = 'Log';
$string['log_help'] = 'The log lists statistics of the page.';
$string['loging'] = 'Log wiki page';
$string['logpage'] = 'Log page \'{$a}\'';
$string['map'] = 'Mapita';
...
$string['mingwpath'] = 'Windows Path';
$string['mingwpath_help'] = 'Path to the compiler for Windows executable';
$string['missingpages'] = 'Pages without content';
$string['modified'] = 'Modified';
$string['modulename'] = 'Wikicode';
$string['modulenameplural'] = 'Wikicodes';
...
$string['pluginadministration'] = 'Wikicode administration';
$string['pluginname'] = 'Wikicode';
...
$string['timeedit'] = 'Editing Time';
$string['timeedit_help'] = 'Time from start of the code editing until completion';
...
$string['wiki'] = 'Wikicode';
$string['wikicode'] = 'Wikicode';
...
$string['wikicode:createpage'] = 'Create new wiki pages';
$string['wikicode:editcomment'] = 'Add comments to pages';
$string['wikicode:editpage'] = 'Save wiki pages';
$string['wikicode:managecomment'] = 'Manage wiki comments';
$string['wikicode:managewiki'] = 'Manage wiki settings';
$string['wikicode:managefiles'] = 'Manage wiki files';
$string['wikicode:overridelock'] = 'Override wiki locks';
$string['wikicode:viewcomment'] = 'View page comments';
$string['wikicode:viewpage'] = 'View wiki pages';
